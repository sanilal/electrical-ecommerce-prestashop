...
class AdminStoresControllerCore extends AdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'mobile' => array('title' => $this->trans('Mobile', array(), 'Admin.Global')),
    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->trans('Mobile', array(), 'Admin.Global'),
                    'name' => 'mobile',
                ),
                array(
                    'type' => 'text',
    ...
    protected function _getDefaultFieldsContent()
    {
        ...
        $formFields = array(
            ...
            'PS_SHOP_MOBILE' => array(
                'title' => $this->trans('Mobile', array(), 'Admin.Global'),
                'validation' => 'isGenericName',
                'type' => 'text',
            ),
            'PS_SHOP_FAX' => array(
